...
// Returns the result of sending the current request.
...
// Return an http.Request struct built from a handlerTestRequest.
...
func (r *handlerTestRequest) SetBody(data *map[string]interface{}) {
	if data == nil {
